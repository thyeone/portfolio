  ...
  },
  {
    ...
    solution: (
      <ul className="ml-4 text-base list-disc">
        ...
        <li>
          400, 50X 과 같은 에러 코드들은 사용자가 에러를 리셋할 수 있는 트리거 장치로 <strong>재시도</strong> 버튼을
          두었어요.
        </li>
        <li>
          점검 페이지나 404 응답의 경우 페이지 전체에 에러를 보여주고 싶었어요. 루트 레벨에 위치한{' '}
          <Inline text="GlobalErrorBoundary" />가 해당 에러를 처리해요.
        </li>
      </ul>
    ),
